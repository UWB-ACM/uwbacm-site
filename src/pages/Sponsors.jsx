			...
			<div id="app">
				...
				<div className="read-section read-section">
					<div className="read-section__center">
						...
						<p>
							...
							STEM-oriented student organization on the UWB campus. Last year, we hosted over 30 events (including a
							100+ person Hackathon) and have contributed to multiple university projects such as the redesigning of the
							Computer Science Labs. Our primary mission is to prepare students both educationally and professionally
							for their transition into the tech industry. <br />
							<br />
				...
				<div className="read-section read-section--gray uwb-acm-need">
					<div className="read-section__center">
						...
						<p>
							...
							mentorship. To understand how this relationship can benefit both our students and your organization,
							please continue.
						</p>
					</div>
				</div>
				...
				<div className="read-section read-section--gray">
					<div className="read-section__center">
						...
						<p>
							...
							benefits. <br />
							<br />
							Our team has carefully selected each sponsorship tier to accurately represent what we need to accomplish
							our goals. However, we will be happy to work with you to build a package tailored for your organization.
				...
				<div className="read-section read-section--gray">
					<div className="read-section__center">
						...
						<p>
							Become part of our Spring Annual Hackathon, a 14+ hour event where students can demonstrate their talent
							and creativity by developing impressive projects in one day. Last year, we saw over 100 students and 20
						...
						<table className="pricing-table">
							<tbody>
								<tr className="pricing-table__header">
									...
									<th>
										<div>
											<span style={{color: '#795548'}}>Copper</span> <span>$1000</span>
										</div>
									</th>
									<th>
										<div>
											<span style={{color: '#FFA726'}}>Bronze</span> <span>$2,000</span>
										</div>
									</th>
									<th>
										<div>
											<span style={{color: '#9baab2'}}>Silver</span> <span>$5,000</span>
										</div>
									</th>
									<th>
										<div>
											<span style={{color: '#FFC107'}}>Gold</span> <span>$10,000</span>
										</div>
									</th>
								</tr>
				...
				<div className="read-section event-sponsorship">
					<div className="read-section__center">
						...
						<div className="signature-event">
							...
							<p>
								The Weekly CTCI Workshop is an opportunity for students to collaborate with one another to solve
								technical questions in a mock interview fashion. Students can use this opportunity to prepare for their
						...
						<table className="pricing-table">
							<tbody>
								<tr className="pricing-table__header">
									...
									<th>
										<div>
											<span style={{color: '#795548'}}>Seed</span> <span>$1000</span>
										</div>
									</th>
									<th>
										<div>
											<span style={{color: '#FFA726'}}>Sapling</span> <span>$5,000</span>
										</div>
									</th>
									<th>
										<div>
											<span style={{color: '#9baab2'}}>Tree</span> <span>$10,000</span>
										</div>
									</th>
									<th>
										<div>
											<span style={{color: '#FFC107'}}>Oak</span> <span>$15,000</span>
										</div>
									</th>
								</tr>
								<tr>
